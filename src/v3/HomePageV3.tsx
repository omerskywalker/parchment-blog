...
import HomeLatestPostsV3 from "./components/HomeLatestPostsV3";
...
interface HomePageV3Props {
  isLoggedIn: boolean;
  posts: (PublicPostCard & { contentMd?: string })[];
}

export default function HomePageV3({ isLoggedIn, posts }: HomePageV3Props) {
