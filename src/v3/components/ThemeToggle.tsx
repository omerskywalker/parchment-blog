 ...
 *   - Renders nothing on the server / before mount to avoid hydration
 *     mismatches — the icon depends on a value that only exists after
 ...
 * shout. It IS the only persistent UI control in the chrome — keep it
 * quiet on purpose.
 */
